...
3. Functional Requirements:
   ...
   - Describe the functionalities, such as[1:04 pm, 02/11/2023] Renuka Clg: task creation, editing, categorization, setting due dates, user registration, authentication, etc.
